...
{
	if(strlen($_POST['announcement'])>0)
	{
		$a=$_POST['announcement'];
		$query="insert into announcement values('$a')";
		$result=mysqli_query($conn,$query);
		if(!$result)
		{
...
Enter the announcement :&nbsp&nbsp&nbsp <input type="text" name="announcement" size="80" maxlength="80"><br><br>
<script>space(100);</script><input type="submit" name="add">
</fieldset>
</form>
</body>
</html>